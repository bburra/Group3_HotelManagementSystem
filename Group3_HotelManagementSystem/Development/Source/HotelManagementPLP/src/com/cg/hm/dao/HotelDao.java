...
public interface HotelDao {
	 ...
	 */
	void addHotel(Hotel hotelDetails) throws HotelManagementException;
	 ...
	 * @throws HotelManagementException
	 */
	void addRoom(RoomDetail roomDetails) throws HotelManagementException;
	 ...
	 * @throws HotelManagementException
	 */
	void updateHotel(Hotel hotelDetails) throws HotelManagementException;

	/**
	 * Updates Room Details in DataBase
	 * 
	 * @param roomDetails
	 *            :Room Oject which is to be Modified
	 * @throws HotelManagementException
	 */
	void updateRoom(RoomDetail roomDetails) throws HotelManagementException;
	 ...
	 * @throws HotelManagementException
	 */
	List<UserDetail> viewGuestListSpecificHotels(int hotelId)
			throws HotelManagementException;
}
